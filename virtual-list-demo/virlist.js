...
(function (global, factory) {
    ...
    function Vlist(param) {
        ...
        this.containerUL = this.container.querySelector("tbody");//容器内的tbody
        ...
        // this.containerUL.addEventListener("scroll", this.scrollEventBind, false);
    }

    Vlist.prototype.renderItem = function (item) {
        var index = item.index;
        var itemDom = item.dom ? item.dom : document.createElement("TR");
    ...
    Vlist.prototype.addData = function (data) {
        ...
        this.container.querySelector("table").style.height = realHeight + 'px';
        if (isInit) {
            this.initList();
        }
        this.closeLoading();
